...
class TicketScreenWidget extends StatefulWidget {
  ...
  @override
  State<TicketScreenWidget> createState() => _TicketScreenWidgetState();
}

class _TicketScreenWidgetState extends State<TicketScreenWidget> {
  late TicketScreenModel _model;
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.loadingticket = true;
                          safeSetState(() {});
                          _model.printNumberApiResult =
                              await TakeANumberAPIGroupGroup.printNumberCall
                                  .call(
                            depart: widget.depart,
                          );

                          if ((_model.printNumberApiResult?.succeeded ??
                              true)) {
                            await actions.printQueueTicket(
                              TakeANumberAPIGroupGroup.printNumberCall
                                  .ticketNumber(
                                (_model.printNumberApiResult?.jsonBody ?? ''),
                              )!,
                              widget.peopleAhead!,
                              widget.deptCode!,
                            );
